...
public class SampleFillTable {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Table table = dynamoDB.getTable("Movies_3");

        JsonParser parser = new JsonFactory().createParser(new File("src/main/java/moviedata.json"));
